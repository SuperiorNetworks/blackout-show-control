...
- **Export format:** `.tdproj` JSON — see [docs/data-schema.md](https://github.com/SuperiorNetworks/downrange-document/blob/main/docs/data-schema.md)
...
```bash
# Clone the repo
git clone https://github.com/SuperiorNetworks/detonator.git
cd detonator
...
DETONATOR exports and imports `.tdproj` files — plain JSON with the following top-level structure:
...
Full schema documentation lives in the [DOWNRANGE DOCUMENT repo](https://github.com/SuperiorNetworks/downrange-document/blob/main/docs/data-schema.md).

---

## Data Sync

Project files and sensor data are synced to `ftp.sndaten.com/irondistrict/` using the workflow documented in the [DOWNRANGE DOCUMENT sync guide](https://github.com/SuperiorNetworks/downrange-document/blob/main/host-tools/sync/README.md).
...
| [DOWNRANGE DOCUMENT](https://github.com/SuperiorNetworks/downrange-document) | Sensor firmware, Python analytics, Blender simulation pipeline |
